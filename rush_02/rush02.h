...
/*   Updated: 2024/07/21 23:17:55 by kfreyer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char					***get_dict(void);
t_SpellNode				*find_node_by_key(char *numerical,
...
/* parse.c */
int						parse_dict(char *dict_filename,
							t_SpellNode **spell_nodes);
...
int						update_dict(char *dict_filename,
							t_SpellNode *spell_nodes);
